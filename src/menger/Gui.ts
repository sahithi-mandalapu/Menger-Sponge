...
// animation interface used by GUI to update sponge level
interface SpongeAnimation extends CanvasAnimation {
...
export class GUI implements IGUI {
  ...
  private animation: SpongeAnimation;
