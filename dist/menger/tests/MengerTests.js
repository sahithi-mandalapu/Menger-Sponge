 ...
 */
mengerTests.integrationTest("W Key", "./static/img/menger/w_fps_ref.png", (animation) => {
    animation.reset();
    pressKey(window, "Digit2", 1);
 ...
 */
mengerTests.integrationTest("S Key", "./static/img/menger/s_fps_ref.png", (animation) => {
    animation.reset();
    pressKey(window, "Digit2", 1);
 ...
 */
mengerTests.integrationTest("A Key", "./static/img/menger/a_fps_ref.png", (animation) => {
    if (animation) {
        animation.reset();
        pressKey(window, "Digit2", 1);
        pressKey(window, "KeyW", 35);
 ...
 */
mengerTests.integrationTest("D Key", "./static/img/menger/d_fps_ref.png", (animation) => {
    if (animation) {
        animation.reset();
        pressKey(window, "Digit2", 1);
        pressKey(window, "KeyW", 35);
 ...
 */
mengerTests.integrationTest("Up Arrow Key", "./static/img/menger/up_arrow_fps_ref.png", (animation) => {
    if (animation) {
        animation.reset();
        pressKey(window, "Digit2", 1);
 ...
 */
mengerTests.integrationTest("Down Arrow Key", "./static/img/menger/down_arrow_fps_ref.png", (animation) => {
    if (animation) {
        animation.reset();
        pressKey(window, "Digit2", 1);
